...
func (p *Asm) Init(options ...func(*Asm) error) error {
	...
	_rules = [...]func() bool{
		...
		func() bool {
			...
			l631:
				add(ruleARMRegister, position630)
			}
			return true
		l629:
		...
		func() bool {
			...
			l679:
				add(ruleARMVectorRegister, position673)
			}
			return true
		l672:
		...
		func() bool {
			...
			l727:
				add(ruleLow12BitsSymbolRef, position719)
			}
			return true
		l718:
		...
		func() bool {
			...
			l762:
				add(ruleARMBaseIndexScale, position729)
			}
			return true
		l728:
		...
		func() bool {
			...
			l773:
				...
				add(ruleARMGOTLow12, position764)
			}
			return true
		l763:
		...
		func() bool {
			position775, tokenIndex775 := position, tokenIndex
			{
				...
				position++
				add(ruleARMPostincrement, position776)
			}
			return true
		l775:
		...
		func() bool {
			...
			l784:
				...
				position++
				add(ruleBaseIndexScale, position778)
			}
			return true
		l777:
		...
		func() bool {
			...
			l842:
				...
				position++
				add(ruleSegmentRegister, position841)
			}
			return true
		l840:
